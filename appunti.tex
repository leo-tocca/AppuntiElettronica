...
\subsubsection{Equazione caratteristica}\label{equazione-caratteristica}
...
detta \textbf{equazione di Shockley}: \(V_d\) indica la differenza di
potenziale applicati ai capi del diodo, \(nV_t\) è il potenziale nativo
dei diodi (pari a 0.7V).. In condizion
