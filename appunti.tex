...
due diodi posti in serie\footnote{Oppure possiamo anche dire che sono
  due giunzioni p-n poste l'una di seguito all'altra e orientata in
  senso inverso, andando poi a costituire tre regioni
  \emph{consecutive}.}, in modo tale da ``condividere'' uno strato.
\newline Ad ogni strato sarà associato un \emph{terminale\footnote{Si
  può esprimere anche come \emph{elettrodo}}}: quello che sarà detto
\textbf{base}, che a sua volta separa due terminali drogati con gli
stessi materiali, che saranno detti rispettivamente \textbf{collettore}
ed \textbf{emettitore}.

Possiamo quindi distinguere due diverse tipologie di BJT: quello
\textbf{npn} e quello \textbf{pnp}. È importante notare come in un
transistore la zona di emettitore è significatimente più drogata di
