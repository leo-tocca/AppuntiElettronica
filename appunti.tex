...
\section{Bipolar Junction Transistor: i BJT (VERSIONE DA
MANTENERE)}\label{bipolar-junction-transistor-i-bjt-versione-da-mantenere}
...
È possibile realizzare la struttura in due diverse modalità: - tipo
\textbf{npn} - tipo \textbf{pnp}
...
e da una di tipo p.~Di fondamentale importanza, è lo \emph{spessore
della base}.
