...
\tightlist
\item
  Effetto \emph{Zener}: prevalente per tensioni di breakdown inferiori
  alla decina di volt;
\item
  Effetto \emph{valanga}: prevalente per tensioni di breakdown superiori
  alla decina di volt.
\end{itemize}
...
\chapter{Bibliografia e sitografia}\label{bibliografia-e-sitografia}
