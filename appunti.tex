...
\(n+\) favorisce il contatto ohmico con l'alluminio.
...
All'atto pratico si ha la corrente del gate sempre nulla (in regime
continuo). L'ossido ha la funzione di isolante, inoltre la lastra è
sottile \((\approx 10 nm)\), la quale \emph{blocca} il passaggio di
corrente dal gate al blocco sottostante, formando una struttura di un
\emph{condensatore a facce piane}.
