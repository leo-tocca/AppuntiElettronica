...
\subsubsection{Equazione caratteristica e
...
\item
  ...
  diodo;
\item
  \(nV_t\) è il potenziale nativo dei diodi (pari a \(0.7 \V\)), o
  \emph{tensione termica}, pari a \(26 \mV\).
\item
  \(I_S\) (o \(I_0\)) è una costante detta \emph{corrente di
  saturazione} (per il \ce{Si} ha valori tra \(10^{-15}\) e
  \(10^{-19} \A\)) In condizioni di polarizzazione diretta la corrente è
  trascurabili per tensioni al di sotto di \(0,5 - 0,6 \V\) e aumenta
